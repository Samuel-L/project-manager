...
export default class PomodoroTimerSettings extends React.Component {
	render() {
		return <div className='timer-settings-pomodoro timer-settings'>
				...
				<form className='pomodoro-settings'>
					<fieldset disabled={this.props.disabled}>
						<input
							...
							onChange={this.props.pomodoroSettingsHandler}/> Work time
						<br/>
						<input
							type='number'
							name='short-break-time'
							value={this.props.defaultShortBreakTime}
							onChange={this.props.pomodoroSettingsHandler}/> Short break time (1-3 pomodoros)
						<br/>
						<input
							type='number'
							name='long-break-time'
							value={this.props.defaultLongBreakTime}
							onChange={this.props.pomodoroSettingsHandler}/> Long break time (4th pomodoro)
						<br/>
						<input
							type='number'
							name='repeat'
							value={this.props.defaultRepeatValue}
							onChange={this.props.pomodoroSettingsHandler}/> Repeat cycle
						<br/>
					</fieldset>
				</form>
			</div>
